...
public class HandPhotoController {
    ...
    public ResponseEntity<HandPhotoUploadResponse> upload(@RequestPart("image") MultipartFile image) {
        HandPhotoUploadResponse response = handPhotoService.upload(image);
